...
export class AvisosController {
  ...
  @ApiResponse({ status: 200, description: 'Retorna 200 se criar o aviso com sucesso.',  type: AvisosResponseDTO })
  ...
  @Get('buscar/:data')
  @HttpCode(HttpStatus.OK)
  @ApiResponse({ status: 200, description: 'Retorna 200 se buscar o aviso por data com sucesso.',  type: AvisosResponseDTO })
  @ApiResponse({ status: 401, description: 'Retorna 401 se não autorizado.' })
