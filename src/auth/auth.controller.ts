...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: 'Retorna 200 se o token for atualizado.' })
  @ApiResponse({ status: 401, description: 'Retorna 401 se não autorizado.' })
  ...
  @Get('eu')
  @ApiResponse({ status: 200, description: 'Retorna 200 se o sistema encontrar o usuário logado.' })
  @ApiResponse({ status: 401, description: 'Retorna 401 se não autorizado.' })
